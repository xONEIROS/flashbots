...
<div align="center">
    <h2>**بار ها پیش آمده است که والت هایی را دیده ایم که توسط هکر ها ، هک شده اند و موجودی آنها خالی شده است ، بعدا هر واریزی که به آن والت انجام شده سریعا از والت خارج شده است**</h2>
</div>
